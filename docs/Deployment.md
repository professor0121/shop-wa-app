...
*   **Dockerfile structure**:
    1.  *Build stage*: Install npm dev dependencies and build front-end files (Vite / Polaris bundle compiled to static files in the dist folder).
    2.  *Production stage*: Clean build containing only backend source files, package.json dependencies, and public asset files.
*   **Containers**:
